...
public class VideoViewerActivity extends AppCompatActivity implements Subject {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backButtonImgView = findViewById(R.id.backButtonImgView);
        ...
        if (intent != null) {
            ...
            Log.d(TAG, "onCreate: "+"data recive success: "+videoPath);
        ...
        backButtonImgView.setOnClickListener(new View.OnClickListener() {
            @Override
